  ...
  <div class="ov-card-body ov-card-body-relative">
    ...
    <div class="ov-card-bottom">
      ...
      <div class="ov-edit-button">
        <a href="javascript:;" class="ov-btn ov-btn-outline-primary" onclick="ovesio.modalButton(event)" data-title="AI Seo Generator Settings" data-url="<?php echo $url_edit; ?>">Edit</a>
      </div>
    </div>
